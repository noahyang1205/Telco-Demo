...
import os
import pandas as pd
input_text = st.text_input("Enter Query here: ", value='', help='Try something like "Get all IPhone rows"')
...
prompt = f"\"\"\"\npandas dataframe foot_traffic, foot_traffic= [ad_id,Date_,Hour_,latitude,longitude,Business_Location_Flag,Collection_Point_InMarket,id_type,Total_coverage_of_id,Total_pings_of_id,Indoor_Flag,BuildingID,TMOCustCnt,TMO_FIagIn,Building,Home_Flag,Category,Industry,Indoor_Flag2]\n without assigning new variable, {input_text}  \"\"\"\n\n\n"
print(f'Prompt: \n {prompt}')
